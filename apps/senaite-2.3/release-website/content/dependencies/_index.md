---
title: "Dependencies"
description: "Container images, layer attribution, and Software Bills of Materials for the senaite-2.3 release."
weight: 1
sidebar:
  open: true
---
...
built from source (invisible to grype).
...
| Plone 5.2.9 + SENAITE 2.3.0              | upstream pinned| upstream (no patches today) | `senaite-lims.vex.json`, `app-images.lock.yaml`                                                                                                                                  | grype against the senaite-lims SBOM                              |
| Deployment composition                   | wellmaintained | wellmaintained engineers | `apps/senaite-2.3/deployments/`                                                                                                                                                 | n/a — composition has no CVE surface of its own                  |
...
- The upstream source fetch (`pkg:github/python/cpython@v2.7.18` for
  Python; `pkg:pypi/senaite.lims@2.3.0` for the LIMS)
