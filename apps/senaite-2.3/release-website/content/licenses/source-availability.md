...
- **Plone 5.2.9 / SENAITE 2.3.0** — pinned versions are in
  [`apps/senaite-2.3/images/senaite-lims/prod.yaml`](https://github.com/wellmaintained/packages-dhi/blob/main/apps/senaite-2.3/images/senaite-lims/prod.yaml).
  Source URLs for each component are recorded in the SBOM.
