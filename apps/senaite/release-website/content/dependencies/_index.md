...
| Plone 5.2.4 + SENAITE 2.0.0             | upstream pinned| upstream (no patches today)| `senaite-lims.vex.json`, `app-images.lock.yaml`                                                                                                                  | grype against the SBOM                                           |
| Deployment composition                  | wellmaintained | wellmaintained engineers | `apps/senaite/deployments/`                                                                                                                                              | n/a — composition has no CVE surface of its own                  |
