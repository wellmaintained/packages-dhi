...
| Plone 5.2.15 + SENAITE 2.6.0 (current line) | upstream pinned| upstream (no patches today)| `senaite-lims.vex.json`, `app-images.lock.yaml`                                                                                                                  | grype against the SBOM                                            |
| Deployment composition                  | wellmaintained | wellmaintained engineers | `apps/senaite-current/deployments/`                                                                                                                                      | n/a — composition has no CVE surface of its own                  |
